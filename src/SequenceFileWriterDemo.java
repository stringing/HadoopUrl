...
public class SequenceFileWriterDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try{
            ...
            writer = SequenceFile.createWriter(conf, fileOption, keyOption, valueOption, SequenceFile.Writer.compression(SequenceFile.CompressionType.RECORD));
            for(int i = 0; i < 100; i++){
                key.set(100 - i);
